...
import kalkulierbar.fosc.FOSCMove
import kalkulierbar.fosc.FOSC
import kalkulierbar.logic.UnaryOp
import java.io.Console

fun applyAx(state: FOSCState, nodeID: Int) : FOSCState {
...
fun applyNotRight(state: FOSCState, nodeID: Int, listIndex: Int): FOSCState {
...
fun applyNotLeft(state: FOSCState, nodeID: Int, listIndex: Int): FOSCState {
...
fun applyOrRight(state: FOSCState, nodeID: Int, listIndex: Int): FOSCState {
...
fun applyOrLeft(state: FOSCState, nodeID: Int, listIndex: Int): FOSCState {
...
fun applyAndRight(state: FOSCState, nodeID: Int, listIndex: Int): FOSCState {
...
fun applyAndLeft(state: FOSCState, nodeID: Int, listIndex: Int): FOSCState {
...
fun checkRight(state: FOSCState, nodeID: Int, listIndex: Int){
    if (nodeID < 0 || state.tree.size <= nodeID)
        throw IllegalMove("nodeID out of Bounds");
...
fun checkLeft(state: FOSCState, nodeID: Int, listIndex: Int){
    if (nodeID < 0 || state.tree.size <= nodeID)
        throw IllegalMove("nodeID out of Bounds");
