            ...
            {foLogic ? ( // Todo: Styling
                <li>
                    ...
                    <p>
                        <ul>
                            <li>
                                1. All constants (identifiers with a lowercase
                                or numeric first character) are terms.
                            </li>
                            <li>
                                2. All variables (identifiers with an uppercase
                                first character) are terms.
                            </li>
                            <li>
                                3. Given n terms t1 to tn, all functions f(t1,
                                t2, ... tn) - where f is an identifier with a
                                lowercase or numeric first character - are
                                terms.
                            </li>
                            <li>4. Nothing else is a term.</li>
                            <li>
                                5. An atomic formula is a relation with one or
                                more terms as arguments, written as R(t1, t2,
                                ... tn) where R is an identifier with an
